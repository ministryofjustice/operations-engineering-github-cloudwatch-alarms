...
| metric_filter_pattern | A map, representing the metric filter, used to create your CloudWatch metric: <pre> metric_filter_pattern = { usernames_equal_to = [] usernames_not_equal_to = [] repositories = [] events = [] organisations = [] }</pre> 
