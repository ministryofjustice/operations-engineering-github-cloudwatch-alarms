...
# Repository Settings Changes
module "unauthorized_users_modify_repository_settings_repo_changes_modernisation_platform_terraform_bastion_linu" {
  source = "./modules/alarm"
...
# Visibility and Access Control
module "unauthorized_users_modify_repository_settings_visibility_modernisation_platform_terraform_bastion_linu" {
  source = "./modules/alarm"
...
# Security Scanning and Vulnerabilities
module "unauthorized_users_modify_repository_settings_security_modernisation_platform_terraform_bastion_linu" {
  source = "./modules/alarm"
...
# Administrative Privileges
module "unauthorized_users_modify_repository_settings_admin_privileges_modernisation_platform_terraform_bastion_linu" {
  source = "./modules/alarm"
...
# Audit Log Modifications
module "unauthorized_users_modify_repository_settings_audit_log_modernisation_platform_terraform_bastion_linu" {
  source = "./modules/alarm"
