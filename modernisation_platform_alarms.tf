...
##################################################################
# modernisation-platform-terraform-ecs-cluster repo alarm events #
##################################################################

# Branch Protection Rule Modifications
module "unauthorized_users_modify_repository_settings_branch_protection_modernisation_platform_terraform_ecs_cluster" {
  source = "./modules/alarm"
...
# Repository Settings Changes
module "unauthorized_users_modify_repository_settings_repo_changes_modernisation_platform_terraform_ecs_cluster" {
  source = "./modules/alarm"
...
# Visibility and Access Control
module "unauthorized_users_modify_repository_settings_visibility_modernisation_platform_terraform_ecs_cluster" {
  source = "./modules/alarm"
...
# Security Scanning and Vulnerabilities
module "unauthorized_users_modify_repository_settings_security_modernisation_platform_terraform_ecs_cluster" {
  source = "./modules/alarm"
...
# Administrative Privileges
module "unauthorized_users_modify_repository_settings_admin_privileges_modernisation_platform_terraform_ecs_cluster" {
  source = "./modules/alarm"
...
# Audit Log Modifications
module "unauthorized_users_modify_repository_settings_audit_log_modernisation_platform_terraform_ecs_cluster" {
  source = "./modules/alarm"
...
################################################################
# modernisation-platform-terraform-s3-bucket repo alarm events #
################################################################

# Branch Protection Rule Modifications
module "unauthorized_users_modify_repository_settings_branch_protection_modernisation_platform_terraform_s3_bucket" {
  source = "./modules/alarm"
...
# Repository Settings Changes
module "unauthorized_users_modify_repository_settings_repo_changes_modernisation_platform_terraform_s3_bucket" {
  source = "./modules/alarm"
...
# Visibility and Access Control
module "unauthorized_users_modify_repository_settings_visibility_modernisation_platform_terraform_s3_bucket" {
  source = "./modules/alarm"
...
# Security Scanning and Vulnerabilities
module "unauthorized_users_modify_repository_settings_security_modernisation_platform_terraform_s3_bucket" {
  source = "./modules/alarm"
...
# Administrative Privileges
module "unauthorized_users_modify_repository_settings_admin_privileges_modernisation_platform_terraform_s3_bucket" {
  source = "./modules/alarm"
...
# Audit Log Modifications
module "unauthorized_users_modify_repository_settings_audit_log_modernisation_platform_terraform_s3_bucket" {
  source = "./modules/alarm"
...
####################################################################
# modernisation-platform-terraform-aws-vm-import repo alarm events #
####################################################################
...
############################################################################
# modernisation-platform-terraform-pagerduty-integration repo alarm events #
############################################################################

# Branch Protection Rule Modifications
module "unauthorized_users_modify_repository_settings_branch_protection_modernisation_platform_terraform_pagerduty_integration" {
  source = "./modules/alarm"
...
# Repository Settings Changes
module "unauthorized_users_modify_repository_settings_repo_changes_modernisation_platform_terraform_pagerduty_integration" {
  source = "./modules/alarm"
...
# Visibility and Access Control
module "unauthorized_users_modify_repository_settings_visibility_modernisation_platform_terraform_pagerduty_integration" {
  source = "./modules/alarm"
...
# Security Scanning and Vulnerabilities
module "unauthorized_users_modify_repository_settings_security_modernisation_platform_terraform_pagerduty_integration" {
  source = "./modules/alarm"
...
# Administrative Privileges
module "unauthorized_users_modify_repository_settings_admin_privileges_modernisation_platform_terraform_pagerduty_integration" {
  source = "./modules/alarm"
...
# Audit Log Modifications
module "unauthorized_users_modify_repository_settings_audit_log_modernisation_platform_terraform_pagerduty_integration" {
  source = "./modules/alarm"
